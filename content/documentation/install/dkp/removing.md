...
1. Run the Deckhouse installer:
   ...
   - `<RELEASE_CHANNEL>` — [release channel](./release-channels/) of the platform in kebab-case. It should match the one set in `config.yaml` during the [installation](./install/steps/install/):
