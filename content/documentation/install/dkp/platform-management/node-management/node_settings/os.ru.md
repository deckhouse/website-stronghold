...
Аналогично настраивается корневой сертификат для containerd, пример приведён в разделе [настроек containerd](./containerd/#добавление-сертификата-для-дополнительного-registry).
