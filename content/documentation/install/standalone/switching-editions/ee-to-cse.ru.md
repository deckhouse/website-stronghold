...
- [в исполнении DP](../../../dp/platform-management/switching-editions/ee-to-cse/).

{{< alert level="warning" >}}
Поддерживается обновление с Stronghold EE 1.15.x до Stronghold CSE 1.16.0. Если используется версия Stronghold EE ниже 1.15.x, сначала [обновитесь до последней версии ветки](../../../dp/update/update/).
{{< /alert >}}
...
1. При необходимости [распечатайте Stronghold](../raft-lost-quorum-recovery/#распечатывание-stronghold).
...
1. Поочерёдно обновите все follower-узлы. На каждом follower-узле:
   ...
   - При необходимости [распечатайте узел Stronghold](../raft-lost-quorum-recovery/#распечатывание-stronghold).
...
1. При необходимости [распечатайте последний узел Stronghold](../raft-lost-quorum-recovery/#распечатывание-stronghold).
