...
Вы можете настроить удаленное подключение к кластеру. Для этого выполните действия согласно [инструкции](../../../platform-management/access-control/user-management/#создание-конфигурационного-файла-для-удаленного-доступа).
