...
Stronghold EE лицензируется отдельно и доступен для использования только в коммерческих редакциях DP. Сравнение редакций — в разделе [«Редакции»](../../about/editions/).
