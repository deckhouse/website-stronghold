...
- Добавлена нативная репликация `Performance` между EE-кластерами: общий keyspace реплицируется на performance-secondary, которые обслуживают чтения локально и форвардят записи на primary.
