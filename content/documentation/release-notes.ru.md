...
В версии `1.19` появилась нативная межкластерная репликация для enterprise-сценариев аварийного восстановления и масштабирования чтений.
...
- Добавлены фильтры путей для performance-secondary с режимами `allow` и `deny` для выборочной репликации хранилищ и пространств имён.
- Добавлена автоматическая перестройка Merkle-индекса при первой загрузке с включённой репликацией после обновления или периода с отключённой репликацией.
