...
Токены могут использоваться напрямую, либо можно использовать [методы аутентификации](auth/),
...
К наиболее важным сопоставляемым данным относится набор из одной или нескольких прикрепленных [политик](../policy/).
...
Это понятие совпадает с [методом аутентификации Token](../user/auth/token/).
