...
{{< alert level="info" >}}
Бэкенд Key/Value, который хранит произвольные секреты, не выдает аренды, хотя иногда возвращает продолжительность аренды. За дополнительной информацией обратитесь к [документации механизма секретов `kv`](../user/secrets-engines/kv/overview/).
{{< /alert >}}
