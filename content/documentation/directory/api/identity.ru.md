...
Эта страница нужна для работы с механизмом идентичности Deckhouse Stronghold через API. Здесь собраны endpoint'ы для управления сущностями, группами, alias, OIDC identity provider и OIDC identity tokens. Раздел будет полезен, если вы настраиваете федерацию идентичности, OIDC-интеграции или хотите использовать Stronghold как источник данных об идентичности.
