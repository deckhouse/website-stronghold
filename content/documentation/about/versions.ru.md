...
- В веб-интерфейсе появилось управление параметрами `KV`-mount.
- В `PKI` появилась поддержка одноэлементных `RDN` в составе distinguished name.
