...
- Running on Linux OS
  ...
  - [HSM Support](./standalone/hsm/) – key encryption using an HSM (Hardware Security Module).
- Running on Deckhouse Kubernetes Platform
  ...
  - [Platform Removal](./removing/removing/) – the process of removing the platform.
