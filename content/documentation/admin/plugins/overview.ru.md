...
linkTitle: "Введение"
weight: 10
description: "Обзор системы плагинов Stronghold и различий между Standalone и DP."
---
...
## Различия между Standalone и DP
...
- в **Deckhouse Platform** администратор описывает список плагинов в `ModuleConfig`, после чего платформа скачивает их, валидирует и помещает в контейнер Stronghold, а затем плагин регистрируется и включается в самом Stronghold.

## Страницы раздела

- [Плагины в Standalone](./standalone/) — настройка plugin directory, регистрация и включение внешних плагинов на Linux-сервере.
- [Плагины в DP](./dp/) — загрузка плагинов через `ModuleConfig` и дальнейшая регистрация в Stronghold.
