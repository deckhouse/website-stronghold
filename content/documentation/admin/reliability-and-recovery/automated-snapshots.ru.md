...
После настройки автоматических снимков рекомендуется периодически проверять их состояние и дополнительно использовать раздел [Восстановление из резервной копии](../Восстановление из резервной копии/) для отработки процедуры восстановления.
