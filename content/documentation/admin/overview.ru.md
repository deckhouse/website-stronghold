...
- Запуск в Deckhouse Kubernetes Platform
  ...
  - [Настройка платформы](../install/dkp/platform-management/node-management/node_group/) - управление узлами кластера, сетью, системами хранения, виртуализацией и разграничением доступов.
