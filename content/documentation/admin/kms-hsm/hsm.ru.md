...
{{< alert level="warning" >}}
Поддержка HSM в текущем виде относится только к Standalone-установке Stronghold. Примеры на этой странице используют локальный конфигурационный файл и `seal "pkcs11"` в конфигурации standalone-сервера.
{{< /alert >}}
