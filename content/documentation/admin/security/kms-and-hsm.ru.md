...
Если требуется дополнительный уровень защиты чувствительных внутренних данных, перейдите в раздел [Двойное шифрование](../sealwrap/).  
Если нужно ознакомиться с поддерживаемыми алгоритмами и криптографическими особенностями, используйте раздел [Криптоалгоритмы](../cryptography/).
