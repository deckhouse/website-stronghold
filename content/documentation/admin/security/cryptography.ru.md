...
Подробнее о настройке `PKI` см. раздел [Механизм секретов PKI](../../user/secrets-engines/pki/).
...
Подробнее о возможностях `Transit` см. раздел [Механизм секретов Transit](../../user/secrets-engines/transit/).
