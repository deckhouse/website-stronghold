...
- Если Stronghold использует `etcd`, `postgresql` или другую внешнюю систему в качестве бэкенда, необходимо использовать штатные механизмы резервного копирования этих систем, а не встроенные команды Stronghold для Raft-снапшотов `stronghold operator raft snapshot`.
