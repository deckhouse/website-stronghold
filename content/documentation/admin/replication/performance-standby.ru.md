...
weight: 40
description: "Обслуживание запросов на чтение standby-узлами внутри одного кластера Stronghold."
---

Performance standby позволяет standby-узлам (неведущим узлам HA) **внутри одного
кластера** обслуживать запросы на чтение локально, а не перенаправлять каждый
запрос на
...
Performance standby включён по умолчанию в Stronghold EE. Дополнительная
...
это было бы без функции performance standby в Stronghold EE.
