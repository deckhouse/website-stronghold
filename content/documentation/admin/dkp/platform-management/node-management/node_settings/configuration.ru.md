...
- Установка и настройки дополнительных пакетов ОС.
  ...
  Пример:
  - [установка kubectl-плагина](./os/#установка-плагина-cert-manager-для-kubectl-на-master-узлах).

- Обновление ядра ОС на конкретную версию.

  Примеры:
  - [обновление ядра Debian](./os/#для-дистрибутивов-основанных-на-debian).
  - [обновление ядра CentOS](./os/#для-дистрибутивов-основанных-на-centos).

- Изменение параметров ОС.

  Примеры:
  - [настройка параметра sysctl](./os/#задание-параметра-sysctl).
  - [добавление корневого сертификата](./os/#добавление-корневого-сертификата).
...
- Настройка containerd.
  ...
  Примеры:
  - [настройка метрик](./containerd/#дополнительные-настройки-containerd).
  - [добавление приватного registry](./containerd/#добавление-приватного-registry-с-авторизацией).
