...
Модуль `control-plane-manager` упрощает настройку kube-apiserver для включения режима [аудита](auditing/).
...
Подробнее об алгоритме работы планировщика и подключении плагинов описано в разделе [Планировщик](scheduler/).
...
Настройка политик аудита подробно рассмотрена в разделе [Аудит](auditing/).
