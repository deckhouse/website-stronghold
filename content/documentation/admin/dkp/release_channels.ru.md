...
При работе в составе платформы Deckhouse Stronghold использует пять каналов обновлений, предназначенных для использования в разных окружениях, к которым с точки зрения надежности применяются разные требования:
...
Подробнее о настройке каналов обновлений читайте в [Обновлении платформы](../../admin/update/update/#каналы-обновлений).
