...
**Operation ID:** `userpass-read-policies-password`

Set, read, or remove the password policy enforced for userpass.

#### Parameters

| Parameter | Type | Location | Required | Description |
|----------|-----|--------------|--------------|----------|
| `policy_name` | string | path | yes | Name of the password policy enforced for userpass. |
| `userpass_mount_path` | string | path | yes | Path that the backend was mounted at |
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `policy_name` | string | no | Name of the password policy enforced for userpass. |

### POST /auth/{userpass_mount_path}/password-policy/{policy_name}

**Operation ID:** `userpass-write-policies-password`
...
### DELETE /auth/{userpass_mount_path}/password-policy/{policy_name}

**Operation ID:** `userpass-delete-policies-password`
...
### GET /auth/{userpass_mount_path}/password_policy/{policy_name}

**Operation ID:** `userpass-read-policies-password-deprecated`
...
**Operation ID:** `userpass-write-policies-password-deprecated`
...
### DELETE /auth/{userpass_mount_path}/password_policy/{policy_name}

**Operation ID:** `userpass-delete-policies-password-deprecated`
...
**Operation ID:** `webauthn-read-configuration`
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `auto_registration` | boolean | no | Whether new users can self-register. |
| `rp_display_name` | string | no | Human-readable name for the Relying Party. |
| `rp_id` | string | no | Relying Party ID. |
| `rp_origins` | array | no | Allowed origins for WebAuthn. |

### POST /auth/{webauthn_mount_path}/config

**Operation ID:** `webauthn-write-configuration`
...
**Operation ID:** `webauthn-begin-login`
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `mediation` | string | no | Optional credential mediation requirement |
| `publicKey` | object | no | PublicKeyCredentialRequestOptions for navigator.credentials.get() |

### POST /auth/{webauthn_mount_path}/login/finish

**Operation ID:** `webauthn-finish-login`
...
**Operation ID:** `webauthn-begin-registration`
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `registration_code` | string | no | One-time registration code returned when the user was created |
...
|----------|-----|--------------|----------|
| `mediation` | string | no | Optional credential mediation requirement |
| `publicKey` | object | no | PublicKeyCredentialCreationOptions for navigator.credentials.create() |

### POST /auth/{webauthn_mount_path}/register/finish

**Operation ID:** `webauthn-finish-registration`
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `message` | string | no | Registration status message |
| `username` | string | no | Registered username |

### GET /auth/{webauthn_mount_path}/user

**Operation ID:** `webauthn-list-users`
...
**Operation ID:** `webauthn-read-user`
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `credential_ids` | array | no | Base64url-encoded credential IDs |
| `credentials` | integer | no | Number of registered WebAuthn credentials |
...
| `token_ttl` | integer | no | The initial ttl of the token to generate |
| `token_type` | string (default: default-service) | no | The type of token to generate, service or batch |
| `user_id_b64` | string | no | Base64url-encoded WebAuthn user ID |
| `username` | string | no | Username |

### POST /auth/{webauthn_mount_path}/user/{name}

**Operation ID:** `webauthn-write-user`
...
|----------|-----|--------------|----------|
| `display_name` | string | no | Display name for the user |
| `registration_code` | string | no | One-time registration code (returned only on create) |
| `username` | string | no | Username |

### DELETE /auth/{webauthn_mount_path}/user/{name}

**Operation ID:** `webauthn-delete-user`
...
**Operation ID:** `webauthn-delete-credential`
...
### POST /auth/{webauthn_mount_path}/user/{name}/generate-code

**Operation ID:** `webauthn-generate-registration-code`

Generate a new one-time registration code for a user
...
| Parameter | Type | Required | Description |
|----------|-----|--------------|----------|
| `registration_code` | string | no | One-time registration code |
| `username` | string | no | Username |

### POST /auth/{webauthn_mount_path}/user/{name}/policies

**Operation ID:** `webauthn-update-policies`
