...
{{< alert level="info" >}}
Возможности работы с SSH также рассмотрены [в курсе «Обзор возможностей Deckhouse Stronghold»](https://education.flant.ru/course/obzor-vozmozhnostej-deckhouse-stronghold/).
{{< /alert >}}
