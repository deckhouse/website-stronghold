...
На этой странице представлен быстрый старт по использованию этого механизма секретов. Возможности работы с SSH также рассмотрены в [курсе «Установка и обзор Deckhouse Stronghold»](https://education.flant.ru/course/ustanovka-i-obzor-deckhouse-stronghold/).
