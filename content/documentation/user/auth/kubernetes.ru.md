...
Подробнее — в [«Изменения в поведении JWT-токенов в Kubernetes 1.21+»](#изменения-в-поведении-jwt-токенов-в-kubernetes-121).
{{< /alert >}}
...
должна иметь разрешение на доступ к `TokenReview API`. Пример `ClusterRoleBinding`,
