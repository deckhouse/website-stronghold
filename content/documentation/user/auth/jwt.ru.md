...
> Примечание  
> Если вам нужен интерактивный вход через браузер и OIDC-провайдера, используйте раздел [OIDC](../OIDC/). В `JWT`-сценарии Stronghold не инициирует browser-based flow, а только валидирует уже выданный токен.
