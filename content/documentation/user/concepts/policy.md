...
These parameters can be used to set minimums and maximums on TTLs set by clients when requesting [response wrapping](response-wrapping/), with a granularity of a second. These use `duration`-format strings.
