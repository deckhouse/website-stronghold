...
> Примечание  
> В этом разделе предполагается, что кластер **Deckhouse Kubernetes Platform** уже установлен и работает корректно. Если это не так, сначала используйте документацию DKP: [/products/kubernetes-platform/documentation/](/products/kubernetes-platform/documentation/).
